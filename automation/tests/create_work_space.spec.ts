...
test('test', async ({ page }) => {
  ...
  await page.getByTestId('input-name').fill('Área ');
  await page.getByTestId('input-name').fill('Área Yanine ');
  await page.getByTestId('input-name').fill('Área Yanine Prueba VIII');
  ...
  await searchInput.fill('yanine pr');
  ...
  const areaCard = page
    ...
    .filter({ hasText: 'Área Yanine Prueba VIII' })
    .first();
